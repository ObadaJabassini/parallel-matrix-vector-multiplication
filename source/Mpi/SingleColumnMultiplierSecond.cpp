...
namespace Mpi{
    ...
    void SingleColumnMultiplierSecond::multiply( std::string result_file_path ) {
        ...
        system((string("mpirun -np ") + to_string(size - 3) + " /home/ojabassini/CLionProjects/parallel-matrix-vector-multiplication/bin/mpi_single_column_second " + file_path + " " + result_file_path).c_str());
    }
}